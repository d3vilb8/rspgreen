...
import { FaCreditCard, FaDownload, FaEdit, FaPaperPlane, FaSms, FaTrash } from 'react-icons/fa';
                    ...
                    <tbody>
                        {salary.map((salary, index) => (
                            <tr key={salary.id} className="border-b">
                                ...
                                <td className='space-x-2'>                                                                <button  type='button'  onClick={(e)=>handleStatus("mail")} className='px-2 py-2 bg-green-500 rounded text-white'><FaPaperPlane /></button>
                                                                                                <button type='button' onClick={(e)=>handleStatus("sms")} className='px-2 py-2 bg-indigo-500 rounded text-white'><FaSms /></button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
