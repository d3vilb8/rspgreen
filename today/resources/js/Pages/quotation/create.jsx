...
const Create = ({ client_idf2, customer_dets, }) => {
    ...
    const handleSubmit = (e) => {
        ...
        post('/Quotation', {
            ...
            onError: (err) => {
                console.log(err);
                notyf.error('Failed to add Quotation. Please check your inputs.')},
        });
    };
    ...
    return (
        <div>
            <Header/>
            <Nav/>
            <div className="w-[80%] ml-[11.5rem] absolute right-0 overflow-hidden px-3">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        />
                        {errors.quotation_amount && <p className="mt-1 text-xs text-red-500">{errors.quotation_amount}</p>}
                    </div>
                    <div>
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <label className="block mb-1 text-sm font-medium text-gray-700">Scope Of Work</label>
                        <textarea name="message" value={data.message} onChange={(e)=>setData('message',e.target.value)} id="" rows="6" className="resize-none border border-gray-300 rounded-lg form-textarea w-full"></textarea>
