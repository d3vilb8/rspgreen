                            ...
                            currentLeave.map(emp => (
                                <tr key={emp.id}>
                                    ...
                                    <td className='p-3 border'>
                                        ...
                                        {emp.is_unpaid === 1 ? (
                                            <p className='text-[1rem] text-center'>Unpaid</p>
                                        ) : (
                                            <p className='text-[1rem] text-center'>Paid</p>
                                        )}
                                    </td>
                                    <td
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            onClick={(e) => {
                                                                ...
                                                                handleToggle(null); // Close the dropdown
                                                            }}
                                        ...
                                        {isModalOpen && (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <h2 className="text-lg font-bold mb-3">Rejection Reason</h2>
                                                    <textarea
                                                        value={rejectReason}
                                    ...
                                    <td className='border'>
                                        <div className='flex space-x-2'>
                                            <Link className='text-white p-2 rounded text-[1.5rem] bg-blue-500'
                                                href={`leave/show/${emp.id}`}><IoIosEye /></Link>
                                            <Link className='bg-green-800 p-2 rounded text-white text-[1.5rem]'
                                                href={`leave-store-edit/${emp.id}`}><FaEdit /></Link>
                                            <button className='bg-red-800 p-2 rounded text-white text-[1.5rem]'
